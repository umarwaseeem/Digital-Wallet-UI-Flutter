...
import 'package:leew_wallet/screens/home_screen/screens/widgets/token_info_tile_provider.dart';
...
class WalletScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tokenProviderData = Provider.of<TokenProvider>(context);
                ...
                Expanded(
                  child: Container(
                    ...
                    child: ListView.builder(
                      shrinkWrap: true,
                      itemCount: tokenProviderData.tokens.length,
                      itemBuilder: (context, index) {
                        return tokenProviderData.tokens[index];
                      },
                    ),
                  ),
                ),
